export const rotationFileContents: Record<string, string> = {
  'src/app/demos/animations/rotation/page.tsx': `'use client'
...
export default function RotationDemo() {
  ...
  'src/app/demos/animations/rotation/components/RotationAnimation.tsx': `'use client'
