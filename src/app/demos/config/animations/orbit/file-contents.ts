export const orbitFileContents: Record<string, string> = {
  'src/app/demos/animations/orbit/page.tsx': `'use client'
...
export default function OrbitDemo() {
  ...
  'src/app/demos/animations/orbit/components/OrbitAnimation.tsx': `'use client'
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 min-h-[calc(100vh-200px)]">
            ...
            <div className="bg-gray-800 rounded-lg overflow-hidden min-h-[500px]">
              <Canvas
                camera={{ 
                  position: [5, 5, 8],  // 軌道全体が見えるようにカメラを調整
                  fov: 60
                }}
                shadows
